...
public class BaturaTextViewV2 extends BaturaTextView {
    public BaturaTextViewV2(Context context) {
        super(context);
    }

    public BaturaTextViewV2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(context,attrs);
    }

    public BaturaTextViewV2(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context,attrs);
    }
