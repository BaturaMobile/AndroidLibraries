...
public class BaturaCircularProgressBar extends ProgressBar{
    ...
    public BaturaCircularProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public BaturaCircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(AttributeSet attrs, int style){
        ...
        //		mSubtitlePaint.setShadowLayer(0.1f, 0, a1, Color.GRAY);
    }
    ...
    public void animateProgressTo(final int start, final int end, final ProgressAnimationListener listener){
        ...
        progressBarAnimator.addListener(new AnimatorListener() {
            ...
            public void onAnimationEnd(final Animator animation) {
                BaturaCircularProgressBar.this.setProgress(end);
                if(listener!=null)
